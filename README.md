...
## [v1.1] - 2025-11-17
### Added
- Book review section with JSON & dynamic UI
- SEO improvements across all pages
- Google Search Console meta verification
- Updated content and keyword optimization

### Updated
- Footer with signature
- Improved map, YouTube, and hero content

## [v1.0] - Initial Release
- Portfolio, map, YouTube fetch, books, events, contact pages
